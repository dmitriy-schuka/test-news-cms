                        ...
                        >
                            <FormLayout>
                                <Select
                                    ...
                                    value={
                                        injectionData?.injectionType ||
                                        undefined
                                    }
                                    onChange={(value) =>
                                        handleChange(value, 'injectionType')
                                    }
                                    placeholder={'Please select injection type'}
                                />

                                {injectionData?.injectionType ===
                                    INJECTION_TYPES[0].value && (
                                    <TextField
                                        label="Image URL"
                                        value={
                                            injectionData?.imageUrl || undefined
                                        }
                                ...
                                {injectionData?.injectionType ===
                                    INJECTION_TYPES[1].value && (
                                    <BlockStack gap={300}>
                                        <TextField
                                            label="Text"
                                            value={
                                                injectionData?.text || undefined
                                            }
                                        ...
                                        <TextField
                                            label="Link (optional)"
                                            value={
                                                injectionData?.linkUrl ||
                                                undefined
                                            }
                                            // onChange={handleChange("url")}
                                            onChange={(value) =>
                                                handleChange(value, 'linkUrl')
                                            }
                                            autoComplete="off"
                                        />
                                    </BlockStack>
                                ...
                                <TextField
                                    ...
                                    onChange={(value) =>
                                        handleChange(Number(value), 'priority')
                                    }
                                    autoComplete="off"
                                    prefix="%"
                                    min={0}
