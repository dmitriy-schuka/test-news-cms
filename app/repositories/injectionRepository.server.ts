...
import type { Injection, InjectionCreate, InjectionUpdate} from "~/@types/injection";

export const createInjection = async (data: InjectionCreate): Promise<Injection> => {
  try {
...
export const getInjectionById = async (id: number): Promise<Injection | null> => {
  try {
...
export const updateInjection = async (id: number, data: InjectionUpdate): Promise<Injection> => {
  try {
